...
void Lab8::Init()
{
    ...
    {
        point_light_pos[1] = lightPosition + lightPosition;
    }
}
...
void Lab8::Update(float deltaTimeSeconds)
{
...

    {
        ...
        // TODO(student): Add or change the object colors
        RenderSimpleMesh(meshes["box"], shaders["LabShader"], modelMatrix, glm::vec3(0.5, 1, 1));
...
void Lab8::RenderSimpleMesh(Mesh *mesh, Shader *shader, const glm::mat4 & modelMatrix, const glm::vec3 &color)
{
    ...
    point_light_pos[0] = glm::vec3(lightPosition.x, lightPosition.y, lightPosition.z);
    point_light_pos[1] = glm::vec3(0, 1, 0);
