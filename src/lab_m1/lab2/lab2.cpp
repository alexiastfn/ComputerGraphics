...
void Lab2::Init()
{
    ...
    // Load a mesh from file into GPU memory
    {
        ...
        //mesh->SetDrawMode(GLenum primitive);  // me: redau topologia in mod diferit
    ...
    // Create a mesh box using custom data
    {
        vector<VertexFormat> vertices
        {
            ...
            VertexFormat(glm::vec3(0, 0,  1), glm::vec3(1, 0.8f, 0.89f), glm::vec3(0.2, 0.8, 0.6)),  // indice 0
            // TODO(student): Complete the vertices data for the cube mesh --- inca 7
            VertexFormat(glm::vec3(1, 0,  1), glm::vec3(1, 0.8f, 0.75f), glm::vec3(0.2, 0.8, 0.6)),   // indice 1
            VertexFormat(glm::vec3(0, 1,  1), glm::vec3(0.8f, 0.85f, 1), glm::vec3(0.2, 0.8, 0.6)),    // indice 2
            VertexFormat(glm::vec3(1, 1,  1), glm::vec3(0.8, 0.65, 1), glm::vec3(0.2, 0.8, 0.6)),   // indice 3
            VertexFormat(glm::vec3(0, 0, 0), glm::vec3(0.85f, 0.75f, 1), glm::vec3(0.2, 0.8, 0.6)),  // indice 4
            VertexFormat(glm::vec3(1, 0, 0), glm::vec3(1, 0.45, 0.89f), glm::vec3(0.2, 0.8, 0.6)),   // indice 5
            VertexFormat(glm::vec3(0, 1, 0), glm::vec3(1, 0.89f, 1), glm::vec3(0.2, 0.8, 0.6)),    // indice 6
            VertexFormat(glm::vec3(1, 1, 0), glm::vec3(1, 0.8f, 1), glm::vec3(0.2, 0.8, 0.6)),    // indice 7
        ...
        vector<unsigned int> indices =
        {
            ...
            // TODO(student): Complete indices data for the cube mesh -- inca 10 triunghiuri
            2, 3, 7,
            2, 7, 6,
            1, 7, 3,
            1, 5, 7,
    ...
    // by definition!
		...
		{   
			...
			VertexFormat(glm::vec3(0, 0,  0), glm::vec3(0.89, 0.8, 1), glm::vec3(0.2, 0.8, 0.6)),   // 0
			// TODO: Complete the information for the cube
			VertexFormat(glm::vec3(2, 0, 0), glm::vec3(1, 0.8, 0.89), glm::vec3(0.2, 0.8, 0.6)),    // 1
			VertexFormat(glm::vec3(2, 0, 2), glm::vec3(1, 0.8, 1), glm::vec3(0.2, 0.8, 0.6)),       // 2
			//VertexFormat(glm::vec3(0, 0, 2), glm::vec3(0.8, 0.8, 1), glm::vec3(0.2, 0.8, 0.6)),
			VertexFormat(glm::vec3(1, 3, 1), glm::vec3(0.6, 0.6, 1), glm::vec3(0.2, 0.8, 0.6)),     // 3
		...
		meshes["tetraedru"]->InitFromData(vertices_tetra, indices_tetra);
        ...
        {
            VertexFormat(glm::vec3(0, 0, 0), glm::vec3(0.2f, 0, 0.4f), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(0, 1, 0), glm::vec3(0.2f, 0, 0.4f), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(1, 0, 0), glm::vec3(0.2f, 0, 0.4f), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(1, 1, 0), glm::vec3(0.2f, 0, 0.4f), glm::vec3(0.2, 0.8, 0.6))
        };
        ...
        meshes["my_square"] = new Mesh("my_square");
        meshes["my_square"]->InitFromData(vertices2, indices2);

        // Actually create the mesh from the data
        //CreateMesh("my_square", vertices2, indices2);
...
void Lab2::Update(float deltaTimeSeconds)
{
    ...
    RenderMesh(meshes["tetraedru"], shaders["VertexColor"], glm::vec3(-0.5f, 0.4f, 0), glm::vec3(0.15f));

    // TODO(student): Draw the square
    RenderMesh(meshes["my_square"], shaders["VertexColor"], glm::vec3(2.5f, 1, 0), glm::vec3(0.75f));
